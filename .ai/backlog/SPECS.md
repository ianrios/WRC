...
- recreate the artists page to be a rolodex style vertical contact card list on mobile and horizontal contact card style on desktop
  ...
  - get example images
- recreate the releases page to be a record crate style depth scroll list list on mobile and desktop
  - this means, when you scroll, you should be going from front to back in the crate instead of up and down on the page
  - on hover, the release image card pops out slightly with an animation
  - on click, the release image card pulls out and becomes the focus, pushing the whole crate down slightly
  - there should be a link to "go to release" that brings you to the whole release epk page
  - get example images
- artist login page
